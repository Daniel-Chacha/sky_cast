...
export const ThreeDText = () => {
    ...
    return (
        <h3 className="text-2xl font-bold sm:text-5xl lg:text-4xl my-4 tracking-widest flex flex-row items-center">
            <span className={`w-40 relative inline-block overflow-hidden transition-all duration-1000 sm:w-80 lg:w-60  text-[#c77826] text-transparent bg-clip-text text-stroke-white
